...
//
{
	BYTE byRed = (BYTE)(crColor & 0xFF); //GetRValue(crColor);
	BYTE byGreen = (BYTE)((crColor & 0xFF00) >> 8);//GetGValue(crColor);
	BYTE byBlue = (BYTE)((crColor & 0xFF0000) >> 16);//GetBValue(crColor);
...
//
{
	...
	BYTE byRed3DDkShadow = (BYTE)(m_crDkShadow & 0xFF);						//GetRValue(m_crDkShadow);
	BYTE byRed3DLiteShadow = (BYTE)(m_crLiteShadow & 0xFF);					//GetRValue(m_crLiteShadow);
	BYTE byGreen3DDkShadow = (BYTE)((m_crLiteShadow & 0xFF00) >> 8);		//GetGValue(m_crDkShadow);
	BYTE byGreen3DLiteShadow = (BYTE)((m_crLiteShadow & 0xFF00) >> 8);		//GetGValue(m_crLiteShadow);
	BYTE byBlue3DDkShadow = (BYTE)((m_crLiteShadow & 0xFF0000) >> 16);		//GetBValue(m_crDkShadow);
	BYTE byBlue3DLiteShadow = (BYTE)((m_crLiteShadow & 0xFF0000) >> 16);	//GetBValue(m_crLiteShadow);
